...
def dict_to_tf_example(data,
  ...
  for obj in data['object']:
    if float(obj['bndbox']['xmin']) < 0 or float(obj['bndbox']['xmin']) >= float(obj['bndbox']['xmax']) or float(obj['bndbox']['xmax'])>width \
       or float(obj['bndbox']['ymin']) < 0 or float(obj['bndbox']['ymin']) >= float(obj['bndbox']['ymax']) or float(obj['bndbox']['ymax']) > height \
       or label_map_dict[obj['name']] < 1 or label_map_dict[obj['name']] > 200:
        print("Warning: image %s is flawed\n"%img_path)
