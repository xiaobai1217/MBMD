...
from core import visualizer, input_reader
...
flags.DEFINE_string('checkpoint_dir', './model/ssd_mobile_imagenet_seq1',
                    'Directory containing checkpoints to evaluate, typically '
                    'set to `train_dir` used in the training job.')
flags.DEFINE_string('eval_dir', './eval/ssd_mobile_imagenet_seq',
                    'Directory to write eval summaries to.')
flags.DEFINE_string('pipeline_config_path', './model/ssd_mobilenet_visualization.config',
...
flags.DEFINE_string('image_root', '/home/lijun/Research/DataSet/ILSVRC2014/ILSVRC2014_DET/image/ILSVRC2013_DET_val',
