...
flags.DEFINE_string('checkpoint_dir', '/media/2TB/Research/Code/memory_augmented_tracker/model/ssd_mobile_sharedpyramid_imagenet1',
                    'Directory containing checkpoints to evaluate, typically '
                    'set to `train_dir` used in the training job.')
flags.DEFINE_string('eval_dir', '/media/2TB/Research/Code/memory_augmented_tracker/eval/ssd_mobile_sharedpyramid_imagenet1',
                    'Directory to write eval summaries to.')
flags.DEFINE_string('pipeline_config_path', '/media/2TB/Research/Code/memory_augmented_tracker/model/ssd_mobilenet_imagenet.config',
