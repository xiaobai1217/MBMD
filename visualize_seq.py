...
from core import visualizer_seq, input_reader
...
flags.DEFINE_string('checkpoint_dir', './model/ssd_mobilenet_video1',
                    'Directory containing checkpoints to evaluate, typically '
                    'set to `train_dir` used in the training job.')
flags.DEFINE_string('eval_dir', './eval/ssd_mobilenet_video1',
                    'Directory to write eval summaries to.')
flags.DEFINE_string('pipeline_config_path', './model/ssd_mobilenet_video_visualization.config',
